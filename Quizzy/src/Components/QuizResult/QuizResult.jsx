...
const QuizResult = ({
  ...
  const [userResultView, setUserResultView] = useState(true);
  const [userDetailedResultView, setUserDetailedResultView] = useState(false);

  const handleView = () => {
    setUserResultView(false);
    setUserDetailedResultView(true);
  };
  ...
  return (
    <>
      ...
      {userDetailedResultView && <ResultDetails answers={answers} />}
    </>
  );
